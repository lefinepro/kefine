export const KEFINE_TEXT_EN = {
  ...
  profile: {
    title: 'Profile',
    subtitle: 'Public profile, social links, completed tasks, and referral settings.',
    onboardingTitle: 'Complete your profile',
    onboardingSubtitle: 'After login, finish the profile in two steps: name and social links.',
