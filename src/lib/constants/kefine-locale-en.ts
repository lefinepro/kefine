export const KEFINE_TEXT_EN = {
  ...
  profile: {
    title: 'Profile',
    subtitle: 'Public profile, social links, completed tasks, referral settings, and card bonus.',
    onboardingTitle: 'Complete your profile',
    onboardingSubtitle: 'After login, finish the profile in three steps: name, card bonus, and social links.',
    ...
    surname: 'Surname',
    identityLeadTitle: 'Set the public identity for your profile',
    identityLeadText:
      'Your first name and surname shape how your profile appears in public links, completed tasks, and follow surfaces.',
    firstNameHint: 'Use your real or working first name. It is shown as the primary part of your public identity.',
    surnameHint: 'Add a surname to make the profile look complete and trustworthy for other participants.',
    bioHint: 'Write a short introduction about your stack, focus, or what people should expect from your profile.',
    continueToCard: 'Continue to card bonus',
    continueToSocials: 'Continue to social links',
    finishSetup: 'Finish setup',
    setupDone: 'Profile setup complete',
    setupHint: 'Finish the steps once and the normal profile view will stay available.',
    ...
    publicHint: 'Your profile is public now. People can discover it, follow it, and use it to attract tasks.',
    privateHint: 'Your profile is private. Open the lock to make it public and attract tasks.',
    ...
    hidden: 'This profile is private.',
    follow: 'Follow',
    following: 'Following',
    followers: 'Followers',
