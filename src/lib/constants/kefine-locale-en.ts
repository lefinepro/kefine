export const KEFINE_TEXT_EN = {
  ...
  create: {
    ...
    pinnedServicesSubtitle: 'Start from configured service entry points before describing a custom lepo.',
  ...
  status: {
    statusPollingMessage: (solver: string, queued: boolean) => `Solver ${solver} is ${queued ? 'accepting' : 'executing'} the lepo`,
  ...
  labels: {
    ...
    searchTasks: 'Search lepos',
    noTasks: 'No lepos found',
    noTasksDescription: 'Create at least one lepo or change search query.',
    openPaymentInvoice: 'Open payment invoice',
    openOrderLink: 'Open order',
    loadMoreHint: 'Scroll to load more lepos',
    executingNow: 'Your lepo is being executed',
    orderStatusUnavailable: 'Waiting for lepo status update...',
    timeLeft: 'Time left:',
    price: 'Price:',
  ...
  buttons: {
    apply: 'Apply',
    createNewTask: 'Create new lepo',
    openAllTasks: 'Open all lepos',
    createTask: 'Create lepo',
    stopTask: 'Stop lepo',
    socialLogin: 'Social login',
    passkeyLogin: 'Passkey login',
    actor: 'Workspace',
    editTaskFeed: 'Edit lepo feed',
  ...
  profile: {
    ...
    save: 'Save workspace',
    signOut: 'Sign out',
    authDrawerSubtitle: 'Quick access to your workspace and recent lepos.',
    openPublicProfile: 'Open public workspace',
    latestTasks: 'Latest lepos',
    projects: 'Projects',
    lepos: 'Lepos',
    closedTasks: 'Closed completed lepos',
    publicTask: 'Make lepo public',
    ...
    following: 'Following',
    followers: 'Followers',
    publicTasks: 'Public lepos',
    noPublicTasks: 'No public lepos yet',
    noRecentTasks: 'No recent lepos yet',
    noOwnerTasks: 'No completed lepos yet',
    openTask: 'Open lepo',
    buyView: 'Buy view',
