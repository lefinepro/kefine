export const KEFINE_TEXT_EN = {
  ...
  profile: {
    ...
    socialOrgActions: 'social.org actions',
    ...
    profileSettingsHint: 'SSH public keys, theme, and language for this workspace.',
    themeSettings: 'Theme',
    ...
    publicZoneHint: 'Public workspace data that visitors can read.',
