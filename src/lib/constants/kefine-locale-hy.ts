...
export const KEFINE_TEXT_HY = {
  ...
  profile: {
    ...
    socialOrgActions: 'social.org գործողություններ',
    copySocialOrg: 'Պատճենել social.org',
    socialOrgCopied: 'social.org-ը պատճենված է',
    downloadSocialOrg: 'Ներբեռնել social.org',
    profileSettingsTitle: 'Կարգավորումներ',
    profileSettingsHint: 'SSH հանրային բանալիներ, թեմա և լեզու այս workspace-ի համար։',
    themeSettings: 'Թեմա',
    languageSettings: 'Լեզու',
    ...
    publicZoneHint: 'Հանրային workspace-ի տվյալներ, որոնք տեսնում են այցելուները։',
