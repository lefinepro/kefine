export const KEFINE_TEXT_RU = {
  ...
  status: {
    ...
    completed: 'Задача завершена. Результат готов.',
  ...
  labels: {
    ...
    taskTree: 'Дерево задачи',
    taskFeed: 'Лента задачи',
  ...
  buttons: {
    ...
    actor: 'Workspace',
    editTaskFeed: 'Редактировать ленту задачи',
  ...
  profile: {
    ...
    signOut: 'Выйти',
    authDrawerSubtitle: 'Быстрый доступ к workspace, публичной ссылке профиля и последним задачам.',
    shareProfile: 'Скопировать ссылку workspace',
    ...
    profileCopied: 'Ссылка workspace скопирована',
    ...
    noRecentTasks: 'Последних задач пока нет',
