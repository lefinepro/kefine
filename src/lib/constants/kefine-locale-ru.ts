export const KEFINE_TEXT_RU = {
  ...
  create: {
    ...
    instantPinLabel: 'Закрепить к промпту',
    instantUnpinLabel: 'Открепить',
    instantPinnedLabel: 'Закреплено к промпту',
    instantMenuLabel: 'Ещё действия',
    instantQrLabel: 'Скачать QR-код',
    instantAgentLabel: 'Посмотреть сайт с помощью агента',
    instantAddProjectLabel: 'Добавить в проект',
    instantQrDownloadLabel: 'Скачать',
  ...
  translatorWidget: {
    ...
    copyTargetAria: 'Скопировать перевод',
    listenSourceAria: 'Прослушать исходный текст',
    listenTargetAria: 'Прослушать перевод',
    voiceInputAria: 'Продиктовать исходный текст',
    saveAria: 'Сохранить перевод',
    shareAria: 'Поделиться переводом',
    likeAria: 'Хороший перевод',
    dislikeAria: 'Плохой перевод',
    languages: {
      auto: 'Авто',
      english: 'Английский',
      russian: 'Русский',
  ...
  weatherWidget: {
    ...
    typeCityHint: 'Введите название города — Москва, Лондон, Токио, Гомель, Париж, Нью-Йорк и любой другой.',
  ...
  profile: {
    ...
    socialOrgActions: 'Действия social.org',
    ...
    profileSettingsHint: 'Публичные SSH-ключи, тема и язык для этого workspace.',
    themeSettings: 'Тема',
    ...
    publicZoneHint: 'Публичные данные workspace, которые видят посетители.',
  ...
  solversView: {
    ...
    settings: 'Настройки',
    openRepositorySettings: 'Открыть настройки репозитория',
    ...
    badges: {
      best: 'Лучший',
      bestTitle: 'Лучший решатель по выбранной метрике',
      deltaTitle: 'Отставание от лучшего решателя по выбранной метрике'
    },
    solversModal: {
      open: 'Сравнить решателей',
      title: 'Сравнение решателей',
      subtitle:
        'Выберите решателя для задачи. Лидер получает знак «Лучший», остальные показывают отставание по выбранной метрике.',
      close: 'Закрыть сравнение решателей',
      rankedBy: 'Сортировка по',
      metricNames: {
      ...
      metricHints: {
        efficiency: 'Больше успеха за доллар',
        success: 'Наибольший процент успеха',
        price: 'Наименьшая цена',
        speed: 'Самый быстрый запуск'
      },
      plotsSubtitle: 'Время выполнения, цена, процент успеха и ценность за доллар',
      empty: 'Пока нет решателей для сравнения.'
    },
    cohortDialog: {
