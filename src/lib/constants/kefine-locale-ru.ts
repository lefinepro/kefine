export const KEFINE_TEXT_RU = {
  ...
  profile: {
    title: 'Профиль',
    subtitle: 'Публичный профиль, соцсети, завершённые задачи и реферальные настройки.',
    onboardingTitle: 'Заполните профиль',
    onboardingSubtitle: 'После входа завершите профиль в два шага: имя и социальные сети.',
