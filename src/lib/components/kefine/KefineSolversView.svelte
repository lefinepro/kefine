...
<div class="solutions-page-container">
  <lef-tasks-grid>
    ...
    {#if !chartsFocused}
      ...
      <lef-task-rail
        aria-label="Solver metrics - click to focus charts"
    ...
    {:else}
      ...
      <div class="charts-main" onclick={() => (chartsFocused = false)} style="cursor: pointer;">
        <SolutionMetricsBlock
          ...
          subtitle="Execution time & weight"
        />
      </div>

      <lef-task-rail aria-label="Compact solvers">
        <lef-task-rail-card>
          <lef-task-rail-head>Solvers</lef-task-rail-head>
        </lef-task-rail-card>
