...
<lef-solver-topbar>
  ...
  {#if onMerge}
    <button
      ...
      aria-label={isMerged ? localeText.solversView.applied : localeText.solversView.applySolution}
    >
      ...
      <lefine-text>{isMerged ? localeText.solversView.applied : localeText.solversView.apply}</lefine-text>
    </button>
  {/if}
</lef-solver-topbar>
