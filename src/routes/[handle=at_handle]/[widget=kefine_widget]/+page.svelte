<script lang="ts">
  ...
  let { data }: { data: { initialActorHandle?: string; initialWidget: KefineSearchWidgetId | null } } = $props();
</script>

{#if Workspace}
  <Workspace initialActorHandle={data.initialActorHandle} initialWidget={data.initialWidget} />
{/if}
