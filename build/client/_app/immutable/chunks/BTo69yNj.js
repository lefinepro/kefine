import{B as e,C as t,g as n,j as r,r as i,u as a,y as o,z as s}from"./BM1uQiqP.js";import{S as c,f as l,g as u,l as d,n as f,o as p,t as m}from"./DLhc71Z4.js";import{o as h,s as g}from"./CCkb-7M-2.js";import{t as _}from"./CRWLuA6A2.js";import"./D_iXza3W2.js";import"./e3I0KlZP2.js";import"./Cc77bbp32.js";import"./DA6g_4gT.js";import"./Bk8MfXK3.js";var v;(function(e){e.approve=`approved`,e.bought=`bought`,e.borrow=`borrowed`,e.burn=`burnt`,e.cancel=`canceled`,e.claim=`claimed`,e.deploy=`deployed`,e.deposit=`deposited`,e.execute=`executed`,e.mint=`minted`,e.receive=`received`,e.repay=`repaid`,e.send=`sent`,e.sell=`sold`,e.stake=`staked`,e.trade=`swapped`,e.unstake=`unstaked`,e.withdraw=`withdrawn`})(v||={});var y=d`
  :host > wui-flex {
    display: flex;
