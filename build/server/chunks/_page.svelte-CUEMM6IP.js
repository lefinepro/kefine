...
//#region src/routes/legal-information/+page.svelte
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		const content = derived(() => getLegalPageContent(store_get($$store_subs ??= {}, "$kefineLocale", kefineLocale), "company", runtimeConfig().company, runtimeConfig().app.legalUpdatedAt[store_get($$store_subs ??= {}, "$kefineLocale", kefineLocale)]));
...
//# sourceMappingURL=_page.svelte-CUEMM6IP.js.map
