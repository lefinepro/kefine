		...
		try {
			...
			if (result instanceof Promise) {
				...
				child.promise = result.then((transformed) => {
					child.#out.push(`<!--[?${JSON.stringify(transformed)}-->`);
					failed_snippet(child, transformed, noop);
					child.#out.push(BLOCK_CLOSE);
				});
				child.promise.catch(noop);
			} else {
				child.#out.push(`<!--[?${JSON.stringify(result)}-->`);
	...
	async #collect_content_async(content = {
		...
		for (const item of this.#out) if (typeof item === "string") content[this.type] += item;
			...
			try {
				...
				failed_renderer.#out.push(`<!--[?${JSON.stringify(transformed)}-->`);
...
var options = {
	...
	templates: {
		app: ({ head, body, assets, nonce, env }) => "<!doctype html>\n<html lang=\"en\">\n  <head>\n    <meta charset=\"utf-8\" />\n    <link rel=\"icon\" href=\"" + assets + "/favicon.png\" />\n    <link rel=\"apple-touch-icon\" href=\"" + assets + "/favicon.png\" />\n    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" />\n    <meta name=\"format-detection\" content=\"telephone=no\" />\n    <title>Lefine - Automated Freelance Exchange</title>\n    " + head + "\n  </head>\n  <body data-sveltekit-preload-data=\"hover\">\n    <section style=\"display: contents\">" + body + "</section>\n  </body>\n</html>\n",
...
async function get_hooks() {
	...
	let init;
	({handle, handleFetch, handleError, handleValidationError, init} = await import('./hooks.server-Cfm7g1Sv.js'));
	let reroute;
	let transport;
	return {
		handle,
...
export { attr_style as $, text_encoder$1 as A, compact as B, normalize_error as C, resolve as D, parse_remote_arg as E, stringify as F, make_trackable as G, stringify$1 as H, INVALIDATED_PARAM as I, read_implementation as J, get_relative_path as K, base64_encode$1 as L, readable as M, set_read_implementation as N, writable as O, head as P, attr as Q, derived as R, escape_html as S, TRAILING_SLASH_PARAM as T, store_get as U, unsubscribe_stores as V, getContext as W, noop as X, index_server_exports as Y, attr_class as Z, ensure_array_like as _, get_message as a, onDestroy as a0, attributes as a1, html as a2, clsx$1 as a3, get as a4, get_hooks as b, coalesce_to_error as c, has_data_suffix as d, strip_data_suffix as e, decode_pathname as f, get_status as g, has_resolution_suffix as h, add_data_suffix as i, add_resolution_suffix as j, find_route as k, disable_search as l, validate_layout_exports as m, normalize_path as n, options as o, parse as p, validate_page_server_exports as q, validate_page_exports as r, strip_resolution_suffix as s, text_decoder as t, noop_span as u, validate_layout_server_exports as v, with_request_store as w, create_remote_key as x, uneval as y, hash as z };
//# sourceMappingURL=exports-CoBtNwQi.js.map
