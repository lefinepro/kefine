...
import { a as event_handler_invalid, g as state_proxy_equality_mismatch, l as hydration_mismatch, n as await_waterfall, v as svelte_boundary_reset_noop } from "./warnings-BnvgxHRp.js";
...
function schedule_effect(signal) {
	...
	if (boundary?.is_pending && (signal.f & 16777228) !== 0 && (signal.f & 32768) === 0) {
	...
	while (effect.parent !== null) {
		effect = effect.parent;
		var flags = effect.f;
		if (is_flushing && effect === active_effect && (flags & 16) !== 0 && (flags & 262144) === 0 && (flags & 32768) !== 0) return;
		if ((flags & 96) !== 0) {
...
function deferred_template_effect(fn, sync = [], async = [], blockers = []) {
	...
	flatten(blockers, sync, async, (values) => {
		create_effect(4, () => fn(...values.map(get)), false);
		if (decrement_pending) decrement_pending();
	});
}
/**
...
function block(fn, flags = 0) {
	var effect = create_effect(16 | flags, fn, true);
...
//#endregion
export { remove_textarea_child as $, props_rest_readonly as $n, previous_batch as $t, destroy_effect as A, reset as An, is_array as Ar, async_derived as At, remove_effect_dom as B, NAMESPACE_SVG as Bn, save as Bt, update_version as C, safe_not_equal as Cn, define_property as Cr, mutable_source as Ct, branch as D, hydrating as Dn, get_descriptors as Dr, state as Dt, block as E, hydrate_template as En, get_descriptor as Er, source as Et, legacy_pre_effect as F, FILENAME as Fn, run$1 as Fr, flatten as Ft, user_effect as G, each_key_duplicate as Gn, pending as Gt, resume_effect as H, bind_invalid_checkbox_value as Hn, unset_context as Ht, legacy_pre_effect_reset as I, HMR as In, run_all as Ir, for_await_track_reactivity_loss as It, listen as J, hydratable_missing_but_required as Jn, current_batch as Jt, user_pre_effect as K, each_key_volatile as Kn, createSubscriber as Kt, managed as L, HYDRATION_ERROR as Ln, to_array as Lr, increment_pending as Lt, effect as M, set_hydrating as Mn, is_promise as Mr, derived_safe_equal as Mt, effect_root as N, skip_nodes as Nn, noop as Nr, user_derived as Nt, component_root as O, next as On, get_prototype_of as Or, update as Ot, effect_tracking as P, ATTACHMENT_KEY as Pn, object_keys as Pr, capture as Pt, autofocus as Q, props_invalid_value as Qn, is_flushing_sync as Qt, move_effect as R, NAMESPACE_HTML as Rn, run as Rt, untrack as S, dynamic_void_element_content as Sn, deferred as Sr, internal_set as St, aborted as T, hydrate_node as Tn, fallback as Tr, set as Tt, teardown as U, component_api_changed as Un, wait as Ut, render_effect as V, UNINITIALIZED as Vn, track_reactivity_loss as Vt, template_effect as W, component_api_invalid_new as Wn, boundary as Wt, without_reactive_context as X, invalid_snippet as Xn, flushSync as Xt, listen_to_event_and_reset_event as Y, hydration_failed as Yn, eager as Yt, add_form_reset_listener as Z, lifecycle_legacy_only as Zn, fork as Zt, safe_get as _, label as _n, LOADING_ATTR_SYMBOL as _r, equals as _t, delegated as a, createContext as an, snippet_without_render_tag as ar, create_element as at, settled as b, trace as bn, STATE_SYMBOL as br, proxy as bt, on as c, getAllContexts as cn, DESTROYED as cr, first_child as ct, active_effect as d, is_runes as dn, EFFECT_PRESERVED as dr, init_operations as dt, set_signal_status as en, rune_outside_svelte as er, $document as et, active_reaction as f, pop as fn, EFFECT_TRANSPARENT as fr, is_firefox as ft, is_destroying_effect as g, get_error as gn, LEGACY_PROPS as gr, sibling as gt, get as h, set_dev_current_component_function as hn, IS_XHTML as hr, should_defer_append as ht, delegate as i, component_context as in, lifecycle_outside_component as ir, create_comment as it, eager_effect as j, set_hydrate_node as jn, is_function as jr, derived as jt, deferred_template_effect as k, read_hydration_instruction as kn, has_own_property as kr, update_pre as kt, replay_events as l, getContext as ln, DIRTY as lr, get_first_child as lt, deep_read_state as m, setContext as mn, INERT as mr, set_attribute as mt, apply as n, queue_micro_task as nn, invalid_default_snippet as nr, child as nt, event as o, dev_current_component_function as on, store_invalid_shape as or, create_fragment as ot, deep_read as p, push as pn, HEAD_EFFECT as pr, merge_text_nodes as pt, validate_effect as q, get_abort_signal_outside_reaction as qn, Batch as qt, create_event as r, add_svelte_meta as rn, invalid_snippet_arguments as rr, clear_text_content as rt, handle_event_propagation as s, dev_stack as sn, svelte_element_invalid_this_value as sr, create_text as st, all_registered_events as t, invoke_error_boundary as tn, experimental_async_required as tr, $window as tt, root_event_handles as u, hasContext as un, EFFECT_OFFSCREEN as ur, get_next_sibling as ut, set_active_effect as v, tag as vn, MAYBE_DIRTY as vr, strict_equals as vt, invalidate_inner_signals as w, hydrate_next as wn, exclude_from_object as wr, mutate as wt, tick as x, snapshot as xn, array_from as xr, increment as xt, set_active_reaction as y, tag_proxy as yn, REACTION_RAN as yr, is as yt, pause_effect as z, NAMESPACE_MATHML as zn, run_after_blockers as zt };

//# sourceMappingURL=events-DKPWC95Q.js.map