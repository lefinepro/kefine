...
<html><head><style>
  body { margin:0; padding:24px; background:#ece4d2; font-family: 'Inter', system-ui, sans-serif; color:#2b2415; }
  .strip { display:flex; gap:24px; align-items:flex-start; }
  .frame { display:flex; flex-direction:column; align-items:center; gap:8px; }
  .frame img { width:${VIEWPORT.width}px; height:${VIEWPORT.height}px; border:1px solid #d6cdb6; border-radius:8px; }
