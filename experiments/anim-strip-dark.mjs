...
<html><head><style>
  body { margin:0; padding:24px; background:#161310; font-family: 'Inter', system-ui, sans-serif; color:#ece4cd; }
  .strip { display:flex; gap:24px; align-items:flex-start; }
  .frame { display:flex; flex-direction:column; align-items:center; gap:8px; }
  .frame img { width:${VIEWPORT.width}px; height:${VIEWPORT.height}px; border:1px solid #3a3528; border-radius:8px; }
